...
public class ProjectHelper {
    private static final String PROJECT_METADATA_NAME = "ics.project.metadata";
    ...
    public String getMetadata(String key) {
        if (this.projectId == null) {
            ...
            PropertySet propertySet = this.propertySetFactory.buildNoncachingPropertySet("ics.project.metadata", this.projectId);
